...
function logCreateProviderRejected(
    ...
    const diagnostic: Record<string, unknown> = {
        ...
        invalid_path_contains_dot_numeric_segment: parserMetadata.invalid_path_contains_dot_numeric_segment,
        invalid_path_starts_with_dollar: parserMetadata.invalid_path_starts_with_dollar,
        invalid_path_contains_numeric_bracket: parserMetadata.invalid_path_contains_numeric_bracket,
        invalid_path_contains_quoted_bracket: parserMetadata.invalid_path_contains_quoted_bracket,
        invalid_path_contains_space: parserMetadata.invalid_path_contains_space,
        invalid_path_contains_colon: parserMetadata.invalid_path_contains_colon,
        invalid_path_contains_wildcard: parserMetadata.invalid_path_contains_wildcard,
        invalid_path_contains_parentheses: parserMetadata.invalid_path_contains_parentheses,
